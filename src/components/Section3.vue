    ...
    <div v-if="show">
      ...
      <v-container v-if="quiz === 1" class="section_quiz">
        <v-card class="card">
          ...
          <v-card-actions>
            <v-spacer/>
            <v-btn flat color="orange" @click="preview">
              <span style="text-transform: capitalize">Voltar</span>
            </v-btn>
            <v-btn flat color="orange" @click="next">
              <span style="text-transform: capitalize">Proxima</span>
            </v-btn>
          </v-card-actions>
        </v-card>
      </v-container>
